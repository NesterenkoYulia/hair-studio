    ...
    <div className={[styles.main_block]}>
      ...
      <div className={[styles.container_mainblock]}>
        <p style={{ textAlign: "left"}}>
          <h6>Правила та Умови (Terms and conditions):</h6>
          <br/>
          ...
          <br/><br/>
          <h6>Правила повернення грошових коштів (Refund Policy):</h6>
          <br/>
          ...
          <br/><br/>
          <h6>За додатковою інформацією звертайтесь до нас за контактами нижче (Контактна інформація):</h6><br/>

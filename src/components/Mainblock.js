    ...
    <div className={[styles.main_block]}>
      ...
      <div className={[styles.tarifblockandfeedback]}>
        ...
        <p style={{ textAlign: "left"}}>
          ...
          <br/><br/>
          <strong>Правила повернення грошових коштів (Refund Policy):</strong>
          <br/>
          ...
          <br/><br/>
          <strong>За додатковою інформацією звертайтесь до нас за контактами нижче (Контактна інформація):</strong><br/>
